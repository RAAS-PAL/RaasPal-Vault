...
- [ ] **The console's Pending cases tab is not on the live console yet** — [[CasePendingPanel]] lives on `feat/dailycasereport-page` (`cafd93a`), unmerged and not on Vercel. Until it ships, only the API is reachable.
